...
function WormholeSphereMesh({
  ...
  useEffect(() => {
    uniforms.uTimeScaleVert.value = uTimeScaleVert;
    uniforms.uNoiseScaleVert.value = uNoiseScaleVert;
    uniforms.uDisplacementScale.value = uDisplacementScale;
  }, [uniforms, uTimeScaleVert, uNoiseScaleVert, uDisplacementScale]);

  const onBeforeCompile = (shader) => {
    shader.uniforms.uTime = uniforms.uTime;
    shader.uniforms.uTimeScaleVert = uniforms.uTimeScaleVert;
    shader.uniforms.uNoiseScaleVert = uniforms.uNoiseScaleVert;
  ...
  return (
    <Suspense fallback={null}>
      <WormholeSphereMesh
        radius={radius}
        detail={detail}
        uTimeScaleVert={uTimeScaleVert}
        uNoiseScaleVert={uNoiseScaleVert}
